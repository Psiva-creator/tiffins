...
const links = [
  ...
  { name: 'Order Queue', path: '/chef/orders', icon: ClipboardList },
  { name: 'Schedule', path: '/chef/schedule', icon: Calendar },
  { name: 'Inventory', path: '/chef/inventory', icon: Package },
  { name: 'Food Wastage', path: '/chef/wastage', icon: Trash2 },
]
      ...
      <div className="px-6 py-5 border-b border-white/10 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-400">Chef Panel</p>
          </div>
        </div>
